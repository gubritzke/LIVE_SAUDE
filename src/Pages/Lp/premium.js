...
import LogoPremium from '../../images/lp/premium/logo-premium.svg'
import LogoLive from '../../images/lp/premium/logo-live.svg'
...
export default function Essencial() {
    return (
        <div id="lp">
            ...
            <div className="lp-left bg-premium ">
                <div className="container animated fadeIn" align="center">
                    <img src={LogoPremium} className="logo-premium" />
                    <h2 className="cl-white font-24">
                        Manter a saúde em dia <b>custa menos do que você imagina.</b><br /> Utilize as melhores clínicas particulares, pelo <b>menor preço,</b><br /> além de outros benefícios, como:
                    </h2>
                    <Carousel
                    ...
                    <img src={LogoLive} className="logo-luve-s" />
                </div>
            </div>
            <div className="lp-right animated fadeIn">
                ...
                <div className="container">
                    <h2 className="title-left cl-purple font-24 f-weight-400">Checkup anual, consultas e exames, orientação nutricional e fitness, além de assistência odontológica, funeral e <b>muito mais.</b> </h2>
                    <div className="bg-green a-partir">
                        <span className="cl-white font-16">
                            Planos<br />
                            a partir de 
                        </span>
                        <span className="cl-white font-32">R$34,90/mês</span>
                    </div>

                    <p className="cl-gray font-16 voce-garante">A Assinatura Live Premium <b>garante o melhor pra você!</b></p>
                    <p className="cl-gray font-16 muito-mais">Conte também com</p>
